...
## AIAG METHOD PCT EFFECTIVE SCORE 
...
+ for each part and operator, create indicator that shows whether complete or incomplete agreement by appraiser across trials  
...
## agreement with standard - INTRA-rater (by inspector)
...
Note: appears to be the same as "accuracy" from the confusion matrix output
